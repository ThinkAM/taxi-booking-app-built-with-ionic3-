...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__card__ = __webpack_require__(464);
...
CardPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [__WEBPACK_IMPORTED_MODULE_2__card__["a" /* CardPage */]],
        imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__card__["a" /* CardPage */])],
    })
], CardPageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_event_event__ = __webpack_require__(153);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CardPage = (function () {
    function CardPage(prof, eProvider, platform, nav, navParams, loadingCtrl, alertCtrl, formBuilder) {
        this.prof = prof;
        ...
        this.platform.ready().then(function () {
            ...
            window.window.PaystackPlugin.chargeCard(function (resp) {
                _this.eProvider.UpdateCard(card, month, year, cvc, amount, email, driverPay).then(function (success) {
                    _this.showPayMentAlert("Card Activation Was Successful", "Thank You.", true);
                }).catch(function (error) { });
            }, function (resp) {
                _this.showPayMentAlert("Card Activation Was Unsuccessful", "Please Input Your Details Correctly Or Try Another Card", false);
            }, {
                cardNumber: card,
                expiryMonth: month,
                expiryYear: year,
